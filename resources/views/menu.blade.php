...
<head>
  ...
  <title>Mbah Djoe Resort - Menu Makanan dan Minuman </title>
<!-- 
Cafe House Template
        ...
        <div class="row">
          <div class="tm-top-header-inner">
            <div class="tm-logo-container">
              ...
              <h1 class="tm-site-name tm-handwriting-font">Mbah Djoe Resort</h1>
            </div>
    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description">Mbah Djoe Resort template is a mobile-friendly responsive <span class="gold-text">Bootstrap v3.3.5 layout</span> by <span class="gold-text">templatemo</span>. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculusnec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.</p>
      ...
      <div>
        <div class="container">
          <div class="row tm-copyright">
           <p class="col-lg-12 small copyright-text text-center">Copyright &copy; 2084 Your Mbah Djoe Resort</p>
         </div>  
       </div>
     </div>
